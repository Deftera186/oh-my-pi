...
- Fixed prewalk stranding on the expensive model when a mid-run compaction dropped its plan nudge before the todo list existed: the plan nudge is now re-injected while the todo gate is still closed ([#10510](https://github.com/can1357/oh-my-pi/issues/10510)).
## [18.1.2] - 2026-09-01
