...
const RECALL_RESULT: &str = r#"{"query":"Which runtime does the user prefer for scripts?","items":[{"id":"mem-4f2a","bank":"global","content":"User prefers Bun over Node for all new scripts in this repo.","context":"Established while wiring up the gallery command tooling.","score":0.92},{"id":"mem-9c81","bank":"global","content":"The TUI renderers live in packages/coding-agent/src/tools/*-render.ts.","context":"Discovered during the gallery-fixtures task.","score":0.78}]}"#;
