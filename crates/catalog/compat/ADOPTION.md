...
| `harmony-leak-mitigation` | wire | `policy.streaming.harmony_leak_mitigation` | `crates/inference/src/recovery/` | — | stored-only: response recovery owns this mitigation; no codec request-shape consumer |
